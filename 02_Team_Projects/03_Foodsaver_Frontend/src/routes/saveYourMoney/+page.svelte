<script>
    ...
    let category = "Save Money When Shopping"; 
  ...
  <div>
    <div class="container">
        ...
        <div class="card-background">
            <div class="card-title">Save YOUR Money</div>
        </div>
  ...
  <style>
    ...
    .card-background {
        width: 100%;
        height: 300px;
        background-image: url("https://carlosdegramos.com/wp-content/uploads/2024/08/Take-our-NMNT-2-week-food-budget-challenge-and-eat-for-55-a-week-1024x538.jpg");
