<script>
  ...
  let category = "Make the Most of Every Part of Your Ingredients"; 
...
<div>
  <div class="container">
      ...
      <div class="card-background">
          <div class="card-title">Make the MOST use of the Ingredients</div>
      </div>
...
<style>
  ...
  .card-background {
      width: 100%;
      height: 300px;
      background-image: url("https://y4c5c8s9.rocketcdn.me/wp-content/uploads/2023/06/How-to-start-a-zero-waste-lifestyle.jpg");
