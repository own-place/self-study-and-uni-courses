            ...
            <div class="lg:col-span-2">
                <div class="bg-gradient-to-r from-purple-500 to-purple-700 shadow-lg rounded-lg p-4 mx-auto lg:mx-0 flex items-center justify-center mb-4 text-white border-4 border-purple-600">
                    <div class="text-center px-6">
                        <h2 class="text-2xl font-bold">INTERNS</h2>
                        <p class="mt-2">View a list of all interns who are currently working with Syntess!</p>
                    </div>
                </div>
                                ...
                                <li class="flex justify-between gap-x-6 py-5">
                                    <div class="flex gap-x-4">
                                        ...
                                        <div class="flex-auto">
                                            ...
                                            <p class="text-sm leading-6 text-gray-900">Intern</p>
                                        </div>
                                    </div>
                                </li>
                            @endif
