<x-guest-layout>
    <div class="p-4">
        <a href="/">
            <img class="mx-auto h-10 w-auto mt-5" src="{{ asset('images/COMPANY_logo_syntess.png') }}" alt="Syntess">
        </a>
        ...
        <div class="mt-6 flex justify-center">
            <form method="POST" action="{{ route('login') }}" class="w-full max-w-sm">
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <button class="flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 mx-4">
